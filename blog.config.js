...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'ae39e3a6f5594e56a760e3d383028f95',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'youmin', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个数字游民的自留地', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://youmin.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '数字游民, 博客, 游民, 互联网', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'info@youmin.org', // 邮箱地址 例如mail@tangly1024.com
